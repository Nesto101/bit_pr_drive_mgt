      ...
      <!-- ka mobile nav kaja -->
      		 ...
      		 <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      		    <ul class="nav navbar-nav">
      					...
      					<li class="dropdown"><a href="#" data-toggle="dropdown" class="dropdown-toggle">View Users <b class="caret"></b></b></a>
      						<ul class="dropdown-menu">
      							<li><a href="view_drivers">Drivers</a></li>
      							<li class="divider"></li>
      							<li><a href="view_employers">Employers</a></li>
      						</ul>
      						</li>
